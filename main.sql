...
CREATE TABLE book_catalogue (
    isbn_no VARCHAR(50) NOT NULL PRIMARY KEY,
...
CREATE TABLE departments (
    department_code VARCHAR(80) NOT NULL PRIMARY KEY,
...
CREATE TABLE quota (
    member_type VARCHAR(2) NOT NULL PRIMARY KEY,
...
INSERT INTO book_issue (member_no, isbn_no, issue_date) VALUES
...
INSERT INTO members (id, name, type, department_code, email) VALUES
...
INSERT INTO students (student_fname, student_lname, id, course, gender, mobile_no, doj, degree) VALUES
